...
public class userProfile extends AppCompatActivity {
    ...
    protected   void onCreate(Bundle savedInstanceState)
    {
        ...
        if (user == null) {
            startActivity(new Intent(userProfile.this, login_page.class));
        }
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri result) {
                                                        ...
                                                        database.getReference().child("users").child("Image").child(firebaseAuth.getCurrentUser().getUid())
                                                                ...
                                                                .addOnFailureListener(new OnFailureListener() {
                                                                    @Override
                                                                    public void onFailure(@NonNull Exception e) {
                                                                        Toast.makeText(userProfile.this, "not uploaded", Toast.LENGTH_SHORT).show();
                                                                    }
                                                                });
                                                    }
                                                })
                                                .addOnFailureListener(new OnFailureListener() {
                                                    @Override
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(userProfile.this, "failed uploaded", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                    }
                                })
